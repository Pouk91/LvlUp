...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://infinite-wildwood-91534.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onEnterWorkOut = function onEnterWorkOut(event) {
	  // console.log('success')
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.enterWorkOut(data).then(ui.enterWorkOutSuccess).catch(ui.enterWorkOutFailure);
	};

	var onGetWorkOuts = function onGetWorkOuts(event) {
	  // console.log('success')
	  event.preventDefault();
	  // const data = getFormFields(this)
	  api.getWorkOuts().then(ui.getWorkOutsSuccess).catch(ui.getWorkOutsFailure);
	};
	...
	var onUpdateWorkOut = function onUpdateWorkOut(event) {
	  ...
	  var id = data.id;
	  // console.log(data.id)
	  api.updateWorkOut(id, data).then(ui.updateWorkOutSuccess).catch(ui.updateWorkOutFailure);
	};
	...
	var onDeleteWorkOut = function onDeleteWorkOut(event) {
	  ...
	  var data = getFormFields(this);
	  // console.log(data.id)
	  api.deleteWorkOut(data.id).then(ui.deleteWorkOutSuccess).catch(ui.deleteWorkOutFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var enterWorkOut = function enterWorkOut(data) {
	  // console.log(data)
	  return $.ajax({
	...
	var updateWorkOut = function updateWorkOut(id, data) {
	  return $.ajax({
	...
	var deleteWorkOut = function deleteWorkOut(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/workouts/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showWorkOutsTemplate = __webpack_require__(13);
	...
	var enterWorkOutSuccess = function enterWorkOutSuccess(data) {
	  // console.log('succes')
	...
	var enterWorkOutFailure = function enterWorkOutFailure(data) {
	  resetFormField();
	  // console.log(data)
	};

	var getWorkOutsSuccess = function getWorkOutsSuccess(data) {
	  $('#messageBanner').text('Here are your workouts');
	  setTimeout(function () {
	    $('#messageBanner').text('');
	  }, 4000);
	  $('.content').empty();
	  var showWorkOutsHtml = showWorkOutsTemplate({ workouts: data.workouts });
	...
	var getWorkOutsFailure = function getWorkOutsFailure(data) {
	...
	var updateWorkOutSuccess = function updateWorkOutSuccess(data) {
	...
	var updateWorkOutFailure = function updateWorkOutFailure(data) {
	...
	var deleteWorkOutSuccess = function deleteWorkOutSuccess(data) {
	...
	var deleteWorkOutFailure = function deleteWorkOutFailure(data) {
	  $('#messageBanner').text('Sorry ID not found. Click get workouts for one!');
	  setTimeout(function () {
	    $('#messageBanner').text('');
	  }, 4000);
	...
	module.exports = {
	  ...
	  enterWorkOutSuccess: enterWorkOutSuccess,
	  enterWorkOutFailure: enterWorkOutFailure,
	  getWorkOutsSuccess: getWorkOutsSuccess,
	  getWorkOutsFailure: getWorkOutsFailure,
	  updateWorkOutSuccess: updateWorkOutSuccess,
	  updateWorkOutFailure: updateWorkOutFailure,
	  deleteWorkOutSuccess: deleteWorkOutSuccess,
	  deleteWorkOutFailure: deleteWorkOutFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"partial","data":data,"blockParams":blockParams,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  <!-- Don't uncomment yet -->\n\n <!-- Developers, why are we using data-id and not just i d?-->\n  <dl data-id=\""
	    ...
	    + "</dd>\n    <!-- "
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.name : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n  <!-- <button data-id=\"button-"
	    + alias2(alias1((data && data.index), depth0))
	    + "\" class=\"btn btn-default removeLastButton\">Delete Workout!</button> -->\n</dl>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return " -->\n    <dt>Reps:</dt>\n    <dd>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.reps : stack1), depth0))
	    + "</dd>\n    <dt>Sets:</dt>\n    <dd>"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.sets : stack1), depth0))
	    + "</dd>\n    <!-- ";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.workouts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
